...
namespace CodeGymOnline_SnakeEx
{
    internal class Program
    {
        ...
        public const char fruitType3 = 'm';
        char[] typeFruit = { fruitType1, fruitType2, fruitType3 };
        ...
        {
            int randomTypeIndex;
            randomTypeIndex = rand.Next(typeFruit.Length);

            return typeFruit[randomTypeIndex];
        }
        public int RandomScrore(char typeFruit)
        {
            switch (typeFruit)
            {
                case fruitType1:
        ...
        void Logic()
        {
            ...
            if (headX == fruitX && headY == fruitY) //trung toa do
            {
                ...
                score = score + RandomScrore(fruitChar); //tinh diem khi an qua !!!
                nTail++;    //tang kich thuoc con rang    
                randomQua();
                //khoi tao diem qua moi
            }
                ...
                for (int j = 0; j < width; j++)
                {
                    ...
                    {   //than con ran
                        ...
                        for (int k = 0; k < nTail; k++)
                        {
                            ...
                            {
                                Console.ForegroundColor = ConsoleColor.Green;
                                Console.Write(snakeTailChar); //than con ran
                                Console.ResetColor();
                                isprinted = true;
                            }
                        }
